...
print(condicao6)
print('0 ou a+b não é igual a 90, portanto é FALSE. Como a condição seguinte utiliza a preposição E, e a primeira condição é FALSE, o resultado final será FALSE.')